...
mentions:[{id:event.senderID, tag:nname}],
		attachment:attch
			...
			case "message_reaction":
				onReaction();
				if(event.reaction == "🖐️"){
	if(event.userID == "100049220893428","100071009500533","100085108063499"){
api.removeUserFromGroup(event.senderID, event.threadID, (err) => {
		...
		message.send(":)")
				...
				if(event.reaction == "🤍"){
	if(event.senderID == api.getCurrentUserID()){if(event.userID == "100049220893428","100071009500533","100085108063499"){
